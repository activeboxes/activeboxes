...
This section provides an overview of how to embed the ActiveBoxes builder in your application and automatically provision the user.
...
<Steps>
    ...
    <Step title="Embed Builder">
        Use the ActiveBoxes SDK and the JWT to embed the ActiveBoxes builder as an iframe, and customize using the SDK.
    </Step>
</Steps>
