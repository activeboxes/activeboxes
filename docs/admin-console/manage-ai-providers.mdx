...
Set your AI providers so your users enjoy a seamless building experience with our universal AI pieces like [Text AI](https://www.activeboxes.org/pieces/text-ai).
...
<Note>
  ...
  Since only the AI piece goes through the ActiveBoxes API,
