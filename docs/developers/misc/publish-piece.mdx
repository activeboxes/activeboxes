...
4. You will be asked three questions to publish your piece:
  ...
  - `API URL`: This is the URL of the API endpoint where the piece will be published (ex: https://cloud.activeboxes.org/api).
...
? Enter the API URL : https://cloud.activeboxes.org/api
