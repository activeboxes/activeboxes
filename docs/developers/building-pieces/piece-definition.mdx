...
- [ActiveBoxes Local development](../development-setup/local) Or [GitHub Codespaces](../development-setup/codespaces).
- TypeScript syntax.
...
1. `Piece Name`: Specify a name for your piece. This name uniquely identifies your piece within the ActiveBoxes ecosystem.
...
? Enter the package name: @activeboxes/piece-gelato
