...
<CardGroup cols={2}>
  ...
  <Card title="Flow Editior" icon="diagram-project" href="/handbook/teams/flow-builder" color="#4ECDC4">
    Build and manage flows to automate your business processes
  </Card>
  <Card title="Flow Execution" icon="gears" href="/handbook/teams/execution-engine" color="#2ECC71">
  ...
  <Card title="Platform Admin" icon="shield-halved" href="/handbook/teams/platform-admin" color="#45B7D1">
    Administer and configure the platform settings and permissions
  </Card>
  <Card title="Sales" icon="handshake" href="/handbook/teams/sales" color="#27AE60">
    Grow revenue by selling ActiveBoxes to businesses
  </Card>
