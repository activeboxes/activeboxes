...
icon: 'ban'
description: "technical limits for ActiveBoxes execution"
---

### Overview

<Warning>
This Limits applies for the **ActiveBoxes Cloud**, and can be configured via environment variables for self-hosted instances.
</Warning>
...
Some pieces utilize the built-in ActiveBoxes key store, such as the Store Piece and Queue Piece.
