...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install ActiveBoxes"
---

ActiveBoxes Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy ActiveBoxes as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy ActiveBoxes with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  <Card title="ActiveBoxes Cloud" icon="cloud" color="##5155D7" href="https://cloud.activeboxes.org/">
