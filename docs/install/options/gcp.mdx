...
After a successful deployment, you can access the ActiveBoxes application by visiting the external IP address of the VM on GCP.

## Production Deployment

Please visit [ActiveBoxes](/install/configuration/environment-variables) for more details on how to customize the application.