---
title: "Easypanel"
description: "Run ActiveBoxes with Easypanel 1-Click Install"
---

Easypanel is a modern server control panel. If you [run Easypanel](https://easypanel.io/docs) on your server, you can deploy ActiveBoxes with 1 click on it.
...
4. Install ActiveBoxes using the dedicated template.
