...
ActiveBoxes' **core** is released as open source under the [MIT license](https://github.com/activeboxes/activeboxes/blob/main/LICENSE) and enterprise / cloud editions features are released under [Commercial License](https://github.com/activeboxes/activeboxes/blob/main/packages/ee/LICENSE)
...
Using the enterprise features (under the packages/ee and packages/server/api/src/app/ee folder) with a self-hosted instance requires an ActiveBoxes license. If you are looking for these features, contact us at [sales@activeboxes.org](mailto:sales@activeboxes.org).
