...
ActiveBoxes uses Crowdin because it helps translators who don't know how to code. It also makes the approval process easier. ActiveBoxes automatically sync new text from the code and translations back into the code.
...
- Please contact us (support@activeboxes.org) if you want to add a new language. We will add it to the project and you can start translating.
