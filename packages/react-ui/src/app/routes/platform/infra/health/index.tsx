  ...
  const healthData = [
    {
      ...
      details: `<b>Current</b>: ${
        ...
        !isVersionUpToDate
          ? 'Upgrade now to enjoy the latest features and bug fixes.\nCheck the changelog <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://github.com/activeboxes/activeboxes/releases" target="_blank">releases</a>.'
          : ''
      }`,
    ...
    },
    {
      ...
      details: socket.connected
        ...
        : 'Connection issues detected.<br>Visit the <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="https://www.activeboxes.org/docs/install/configuration/troubleshooting" target="_blank">troubleshooting guide</a> for more details.',
