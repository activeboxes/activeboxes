import { createPiece, OAuth2PropertyValue, PieceAuth } from '@activeboxes/pieces-framework';
...
export const googleSearchConsoleAuth = PieceAuth.OAuth2({
  ...
  12. Add https://cloud.activeboxes.org/redirect in **Authorized redirect URIs** field, and click on the Create button.
...
export const googleSearchConsolePiece = createPiece({
  ...
  logoUrl: 'https://cdn.activeboxes.org/pieces/google-search-console.png',
